...
**Demo**: [https://oretti3.github.io/facial-kinetic-sync/](https://oretti3.github.io/facial-kinetic-sync/)
...
**4.4. マルチスレッド観測 (Multi-threaded Observation)**
Ver 0.2 より、最大 5 名までの被験者を同時追跡する並列処理機能を実装した。
各対象は固有IDにより識別され、視覚範囲から一時的に消失した場合でも、約 0.3 秒以内であれば同一人物として再補足される。
（このID保持期間は、システムリソースの最適化と誤認防止の観点から意図的に短く設定されている）
...
**6. 技術詳細**
*   **Core**: Next.js 16
*   **Vision Engine**: MediaPipe Tasks Vision (Hybrid Image/Video Mode)
*   **Language**: TypeScript
